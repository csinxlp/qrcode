...
public class QRCodeUtils {
     ...
     * @throws Exception
     */
    static String generateQRCode(String text, int width, int height, String format) throws Exception {
     ...
     * @return 生成的验证码
     */
    static String generateNumCode(int length) {
        String val = "";
        String charStr = "char";
        String numStr = "num";
     ...
     * @return
     */
    static String parseQRCode(String filePath) {
        String content = "";
        try {
